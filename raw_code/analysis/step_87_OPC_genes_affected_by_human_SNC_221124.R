...
## Script Purpose: OPC genes affected by human SNC                                 ##
## Data: 2022.11.24                                                                ##
## Author: Yiming Sun                                                              ##
#####################################################################################
...
#save gene list
saveRDS(object = gene_list,file = './res/step_87_fig_221124/gene_list.rds')
...
char <- paste0('./res/step_87_fig_221124/',gene_name,'_human_macaque_RNA_express_featureplot.pdf')
