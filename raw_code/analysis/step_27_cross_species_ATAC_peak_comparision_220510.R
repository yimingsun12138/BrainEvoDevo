...
macaque_peakset_lifted <- my_unique_peakset_liftover(ori_GRanges = macaque_peakset,
                                                     ...
                                                     tmp_path = './res/step_27_fig_220510/tmp_2205101318/')
...
macaque_human_merged_peakset <- my_bedtools_merge(peakset_x = macaque_peakset_lifted$mapped,
                                                  ...
                                                  d = 0,tmp_path = './res/step_27_fig_220510/tmp_2205101333/')
...
macaque_human_merged_peakset <- my_unique_peakset_liftover(ori_GRanges = macaque_human_merged_peakset,
                                                           ...
                                                           tmp_path = './res/step_27_fig_220510/tmp_2205101336/')

#save data
saveRDS(macaque_human_merged_peakset,file = './res/step_27_fig_220510/macaque_human_merged_peakset.rds')
...
mouse_peakset_lifted <- my_unique_peakset_liftover(ori_GRanges = mouse_peakset,
                                                   ...
                                                   liftOver_mismatch = 0.1,length_mismatch = 0.1,
                                                   mapped_chr = unique(as.character(human_peakset@seqnames)),
                                                   tmp_path = './res/step_27_fig_220510/tmp_2205101359/')
...
macaque_human_mouse_merged_peakset <- my_bedtools_merge(peakset_x = mouse_peakset_lifted$mapped,
                                                        ...
                                                        bedtools_path = '/data/User/sunym/software/bedtools/bedtools',
                                                        d = 0,tmp_path = './res/step_27_fig_220510/tmp_2205101413/')
...
Brain_ATAC_peakset_mouse <- my_unique_peakset_liftover(ori_GRanges = macaque_human_mouse_merged_peakset,
                                                       ...
                                                       tmp_path = './res/step_27_fig_220510/tmp_2205101418/')
...
Brain_ATAC_peakset_macaque <- my_unique_peakset_liftover(ori_GRanges = Brain_ATAC_peakset_mouse$ori,
                                                         ...
                                                         liftOver_mismatch = 0.1,length_mismatch = 0.1,
                                                         mapped_chr = unique(as.character(macaque_peakset@seqnames)),
                                                         tmp_path = './res/step_27_fig_220510/tmp_2205101436/')
...
Brain_ATAC_peakset_mouse <- my_unique_peakset_liftover(ori_GRanges = Brain_ATAC_peakset_macaque$ori,
                                                       ...
                                                       liftOver_mismatch = 0.1,length_mismatch = 0.1,
                                                       mapped_chr = unique(as.character(mouse_peakset@seqnames)),
                                                       tmp_path = './res/step_27_fig_220510/tmp_2205101446/')
...
saveRDS(Brain_ATAC_peakset,file = './res/step_27_fig_220510/Brain_ATAC_peakset.rds')
...
#save data
saveRDS(human_peak_matrix,file = './res/step_27_fig_220510/human_peak_matrix.rds')
...
#save data
saveRDS(macaque_peak_matrix,file = './res/step_27_fig_220510/macaque_peak_matrix.rds')
...
#save data
saveRDS(mouse_peak_matrix,file = './res/step_27_fig_220510/mouse_peak_matrix.rds')

# create Brain peak matrix ------------------------------------------------
Brain_ATAC_peakset <- readRDS(file = './res/step_27_fig_220510/Brain_ATAC_peakset.rds')
human_peak_matrix <- readRDS(file = './res/step_27_fig_220510/human_peak_matrix.rds')
macaque_peak_matrix <- readRDS(file = './res/step_27_fig_220510/macaque_peak_matrix.rds')
mouse_peak_matrix <- readRDS(file = './res/step_27_fig_220510/mouse_peak_matrix.rds')
...
saveRDS(Brain_peak_matrix,file = './res/step_27_fig_220510/Brain_peak_matrix_Seurat.rds')
...
#UMAP
Brain_peak_matrix <- RunUMAP(object = Brain_peak_matrix,dims = 1:20,reduction = 'pca')
...
pdf(file = './res/step_27_fig_220510/Brain_peak_matrix_umap_dimplot.pdf',width = 6,height = 5)
...
pdf(file = './res/step_27_fig_220510/Brain_peak_matrix_hclust.pdf',width = 12,height = 6)
plot(hc)
dev.off()
...
#filter out all RG sample
RG_peak_matrix <- Brain_peak_matrix[,Brain_peak_matrix$cell_type == 'RG']
RG_peak_matrix <- NormalizeData(object = RG_peak_matrix,assay = 'RNA',
                                normalization.method = 'LogNormalize',
                                scale.factor = 10000,verbose = TRUE)

#find variable features
Idents(RG_peak_matrix) <- 'species'
temp <- FindAllMarkers(object = RG_peak_matrix,assay = 'RNA',test.use = 'DESeq2',slot = 'counts',verbose = TRUE,only.pos = FALSE,min.cells.group = 2)
temp <- temp[temp$p_val_adj < 0.05,]
VariableFeatures(RG_peak_matrix) <- unique(temp$gene)
RG_peak_matrix <- ScaleData(object = RG_peak_matrix,features = VariableFeatures(RG_peak_matrix),assay = 'RNA',vars.to.regress = NULL,do.scale = TRUE,do.center = TRUE,verbose = TRUE)

#plot
mat <- RG_peak_matrix
# group <- kmeans(mat@assays$RNA@scale.data,centers = 6)$cluster
# saveRDS(group,file = './res/step_27_fig_220510/Brain_peak_matrix_RG_gene_list_kmeans_group.rds')
group <- readRDS(file = './res/step_27_fig_220510/Brain_peak_matrix_RG_gene_list_kmeans_group.rds')
col_anno <- HeatmapAnnotation(species = mat$species,which = 'column')

pdf(file = './res/step_27_fig_220510/RG_peak_matrix_heatmap.pdf',width = 8,height = 10)
Heatmap(matrix = as.matrix(mat@assays$RNA@scale.data),
        show_column_names = FALSE,show_row_names = FALSE,
        cluster_rows = FALSE,row_split = factor(group,levels = c(3,5,2,4,6,1)),
        cluster_columns = TRUE,clustering_method_columns = 'complete',
        column_split = factor(mat$species,levels = c('mouse','macaque','human')),
