...
## Script Purpose: Ex-2 genes affected by human SNC                                ##
## Data: 2022.11.22                                                                ##
## Author: Yiming Sun                                                              ##
#####################################################################################
...
#save gene list
saveRDS(object = gene_list,file = './res/step_84_fig_221122/gene_list.rds')
...
char <- paste0('./res/step_84_fig_221122/',gene_name,'_human_macaque_RNA_express_featureplot.pdf')
...
char <- paste0('./res/step_84_fig_221122/',motif_name,'_motif_view.pdf')
...
#plot
char <- paste0('./res/step_84_fig_221122/human_',gene_name,'_trackplot.pdf')
...
#plot
char <- paste0('./res/step_84_fig_221122/macaque_',gene_name,'_trackplot.pdf')
pdf(file = char,width = 8,height = 8)
p_track_plot %>% insert_bottom(plot = p_peak_anno,height = 0.05) %>% insert_bottom(plot = p_p2g,height = 0.1) %>% insert_bottom(plot = p_gene_anno,height = 0.05)
dev.off()
