...
# load RNA scope data -----------------------------------------------------
RNA_Scope_stat <- './res/step_128_fig_230808/ITGA2.xlsx'
...
pdf(file = './res/step_128_fig_230808/ITGA2_normalized_fluorescence_intensity_barplot.pdf',width = 4.5,height = 4)
...
RNA_Scope_stat <- './res/step_128_fig_230808/GPX3.xlsx'
sheet_names <- excel_sheets(path = RNA_Scope_stat)
for (i in sheet_names) {
  temp <- i
  temp <- read_excel(path = RNA_Scope_stat,sheet = temp)
...
pdf(file = './res/step_128_fig_230808/ITGA2_GPX3_normalized_fluorescence_intensity.pdf',width = 8,height = 4)
