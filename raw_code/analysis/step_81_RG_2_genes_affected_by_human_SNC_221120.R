...
## Script Purpose: RG-2 genes affected by human SNC                                ##
## Data: 2022.11.20                                                                ##
## Author: Yiming Sun                                                              ##
#####################################################################################
...
#save gene list
saveRDS(object = gene_list,file = './res/step_81_fig_221120/gene_list.rds')
...
char <- paste0('./res/step_81_fig_221120/',gene_name,'_human_macaque_RNA_express_featureplot.pdf')
...
char <- paste0('./res/step_81_fig_221120/',motif_name,'_motif_view.pdf')
...
#plot
char <- paste0('./res/step_81_fig_221120/human_',gene_name,'_trackplot.pdf')
...
#plot
char <- paste0('./res/step_81_fig_221120/macaque_',gene_name,'_trackplot.pdf')
pdf(file = char,width = 8,height = 8)
p_track_plot %>% insert_bottom(plot = p_peak_anno,height = 0.05) %>% insert_bottom(plot = p_p2g,height = 0.1) %>% insert_bottom(plot = p_gene_anno,height = 0.05)
dev.off()
...
#plot gene annotation
human_anno <- human_anno[which(human_anno$gene_name != 'RN7SL870P'),]
p_gene_anno <- trancriptVis(gtfFile = human_anno,collapse = TRUE,
                            Chr = gsub(pattern = 'chr',replacement = '',x = chrom,fixed = TRUE),
                            posStart = start_site,posEnd = end_site,textLabel = 'gene_name',
                            addNormalArrow = FALSE,text.pos = 'middle',
