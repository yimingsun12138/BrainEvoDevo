...
saveRDS(Brain_ATAC_peakset,file = './res/step_32_fig_220603/Brain_ATAC_peakset.rds')
...
#save data
saveRDS(human_peak_matrix,file = './res/step_32_fig_220603/human_peak_matrix_Seurat.rds')
...
#save data
saveRDS(macaque_peak_matrix,file = './res/step_32_fig_220603/macaque_peak_matrix_Seurat.rds')
...
#save data
saveRDS(mouse_peak_matrix,file = './res/step_32_fig_220603/mouse_peak_matrix_Seurat.rds')

# create Brain peak matrix ------------------------------------------------
#load data
Brain_ATAC_peakset <- readRDS(file = './res/step_32_fig_220603/Brain_ATAC_peakset.rds')
human_peak_Seurat <- readRDS(file = './res/step_32_fig_220603/human_peak_matrix_Seurat.rds')
macaque_peak_Seurat <- readRDS(file = './res/step_32_fig_220603/macaque_peak_matrix_Seurat.rds')
mouse_peak_Seurat <- readRDS(file = './res/step_32_fig_220603/mouse_peak_matrix_Seurat.rds')
...
saveRDS(Brain_peak_matrix,file = './res/step_32_fig_220603/Brain_peak_matrix_Seurat.rds')
...
#UMAP
Brain_peak_matrix <- RunUMAP(object = Brain_peak_matrix,dims = 1:9,reduction = 'pca')
...
pdf(file = './res/step_32_fig_220603/Brain_peak_matrix_umap_dimplot.pdf',width = 6,height = 5)
...
pdf(file = './res/step_32_fig_220603/Brain_peak_matrix_hclust.pdf',width = 12,height = 6)
plot(hc)
dev.off()
