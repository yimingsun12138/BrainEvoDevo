...
mouse_multiome_ArchR <- ArchRProject(
  ...
  outputDirectory = '/data/User/sunym/project/Brain/processed_data/221008_summary/mouse_multiome_ArchR_221009',
  copyArrows = TRUE,
...
#save data
saveArchRProject(ArchRProj = mouse_multiome_ArchR, outputDirectory = "/data/User/sunym/project/Brain/processed_data/221008_summary/mouse_multiome_ArchR_221009/", load = FALSE, overwrite = TRUE)

# QC plot ------------------------------------------------------------------
mouse_multiome_ArchR <- loadArchRProject(path = '/data/User/sunym/project/Brain/processed_data/221008_summary/mouse_multiome_ArchR_221009/')
...
pdf(file = './res/step_16_fig_221009/TSS_enrichment_vs_nFrag_dotplot.pdf',width = 12,height = 10)
...
pdf(file = './res/step_16_fig_221009/TSS_enrichment_vlnplot.pdf',width = 4,height = 4)
p
dev.off()
...
pdf(file = './res/step_16_fig_221009/nFrag_vlnplot_.pdf',width = 5,height = 5)
p
dev.off()
...
pdf(file = './res/step_16_fig_221009/frag_length_.pdf',width = 7,height = 5)
...
pdf(file = './res/step_16_fig_221009/TSS_accessibility_by_sample.pdf',width = 7,height = 5)
p + theme(legend.text = element_text(size = 10), legend.position = 'right')
dev.off()
